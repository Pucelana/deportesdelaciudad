...
def crear_historial_parquesol():
    ...
    return render_template(
        ...
        deporte="futbol",
        equipo="CD Parquesol",
        crear_url="parquesol_route_bp.crear_historial_parquesol",
        modificar_url="parquesol_route_bp.modificar_historial_parquesol",
        eliminar_url="parquesol_route_bp.eliminar_historial_parquesol"
    )
...
@parquesol_route_bp.route("/admin/crear_palmares_parquesol", methods=["GET", "POST"])
def crear_palmares_parquesol():
    ...
    return render_template(
        ...
        deporte="Fútbol",
        equipo="CD Parquesol",
        crear_url="parquesol_route_bp.crear_palmares_parquesol",
        modificar_url="parquesol_route_bp.modificar_palmares_parquesol",
        eliminar_url="parquesol_route_bp.eliminar_palmares_parquesol",
    )
