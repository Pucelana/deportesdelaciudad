...
const filas1 = document.querySelectorAll("#tablaPlayVrac tbody tr");
...
const partidosPlayOff = 66; // Número de partidos para llegar a los playoffs
const equiposPlay = [];
let index1 = 1;
filas1.forEach((fila) => {
...
const tabla1 = document.querySelector("#tablaPlayVrac tbody");
...
equiposPlay.forEach((equipoData) => {
    ...
    equipoData.equipo.includes("VRAC") ? "equipo-pucela" : ""}">${equipoData.equipo}</td>
...
const filas2 = document.querySelectorAll("#tablaDescVrac tbody tr");
...
// Actualizar la tabla con los datos ordenados
const tabla2 = document.querySelector("#tablaDescVrac tbody");
