...
/*function calcularEstadisticas() {
    const tablaDatos = document.getElementById('tablaClasifTierno');
...
const filas = document.querySelectorAll("#tablaAscensoTierno tbody tr");
...
const tabla = document.querySelector("#tablaAscensoTierno tbody");
...
equipos.forEach((equipoData) => {
    ...
    <td class="fw-bold size_equipos text-center">${equipoData.equipo}</td>
...
const filas1 = document.querySelectorAll("#tablaPlayTierno tbody tr");
...
const tabla1 = document.querySelector("#tablaPlayTierno tbody");
...
const filas2 = document.querySelectorAll("#tablaDescTierno tbody tr");
...
const tabla2 = document.querySelector("#tablaDescTierno tbody");
