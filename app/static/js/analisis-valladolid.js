...
const proximidadFijar1 = 75; // Ajusta este valor según tus necesidades
const equipos1 = [];
let index1 = 1;
filas1.forEach((fila) => {
    ...
    // Calcular puntos necesarios para alcanzar la proximidad fija
    const puntosPermanencia1 = proximidadFijar1;
    // Calcular la proximidad de ascenso
    ...
    const partidosGanadosPesimistas1 = Math.min(partidosGanadosMatematicos1 - 2, puntosPermanencia1);
    const partidosGanadosOptimistas1 = Math.min(partidosGanadosMatematicos1 - 4, puntosPermanencia1);
    equipos1.push({
        index1: index1,
        equipo1,
        partidosJugados1,
...
equipos3.forEach((equipo3Data) => {
    ...
    let claseColor3 = '';
    if (equipo3Data.index3 <= 2) {
        claseColor3 = 'pos-nada';
    } else if (equipo3Data.index3 <= 6){
        claseColor3 = 'pos-playoff';        
...
const partidosTotales6 = 42; // Cambiado a 42 partidos en la temporada
const puntosPorGanar6 = 3; // Cambiado a 3 puntos por partido ganado
const proximidadFijar6 = 50; // Ajusta este valor según tus necesidades
const equipos6 = [];
let index6 = 1;
filas6.forEach((fila) => {
    ...
    // Calcular puntos necesarios para alcanzar la proximidad fija
    const puntosPermanencia6 = proximidadFijar6;
    // Calcular la proximidad de ascenso
    ...
    const partidosGanadosOptimistas6 = Math.min(partidosGanadosMatematicos6 - 4, puntosPermanencia6);
    equipos6.push({
        index6: index6,
        equipo6,
        partidosJugados6,
...
equipos6.forEach((equipo6Data) => {
    ...
    let claseColor6 = '';
    if (equipo6Data.index6 <= 18) {
        claseColor6 = 'pos-nada';
    } else if (equipo6Data.index6 <= 22) {
...
// Novena función para calcular el porcentaje al Campeón y Ascenso
const filas7 = document.querySelectorAll("#tablaCampeonVallad tbody tr");
const partidosTotales7 = 42; // Cambiado a 38 partidos en la temporada
const puntosPorGanar7 = 3; // Cambiado a 3 puntos por partido ganado
const proximidadFija7 = 90; // Ajusta este valor según tus necesidades
const equipos7 = [];
let index7 = 1;
filas7.forEach((fila) => {
    ...
    // Calcular puntos necesarios para alcanzar la proximidad fija
    const puntosParaChampions = proximidadFija7;
    // Calcular la proximidad de ascenso
    ...
    const partidosGanadosOptimistas7 = Math.min(partidosGanadosMatematicos7 -5, puntosParaChampions);
    equipos7.push({
        index7: index7,
        equipo7,
        partidosJugados7,
...
equipos7.forEach((equipo7Data) => {
    ...
    let claseColor7 = '';
    if (equipo7Data.index7 <= 2) {
        claseColor7 = 'pos-ascen';   
    } else if (equipo7Data.index7 <=22) {
