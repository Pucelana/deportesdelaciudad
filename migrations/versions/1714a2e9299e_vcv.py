...
Revision ID: 1714a2e9299e
Revises: 012c1e641d3f
Create Date: 2026-06-04 12:11:49.919569
...
revision = '1714a2e9299e'
down_revision = '012c1e641d3f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('clasificacion_euro_vcv',
    ...
    op.create_table('jornadas_vcv',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nombre', sa.String(length=255), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('playoff_vcv',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('eliminatoria', sa.String(length=20), nullable=False),
    sa.Column('fecha', sa.String(length=20), nullable=True),
    sa.Column('hora', sa.String(length=10), nullable=True),
    ...
    op.create_table('vcv_clubs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nombre', sa.String(length=255), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('vcv_partidos',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('orden', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['jornada_id'], ['jornadas_vcv.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('vcv_partidos')
    op.drop_table('vcv_clubs')
    op.drop_table('playoff_vcv')
    op.drop_table('jornadas_vcv')
    op.drop_table('europa_vcv')
    op.drop_table('copa_vcv')
    op.drop_table('clasificacion_euro_vcv')
    # ### end Alembic commands ###
