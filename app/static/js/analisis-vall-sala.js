...
/*function calcularEstadisticas() {
    const tablaDatos = document.getElementById('tablaClasifGalvan');
...
const filas = document.querySelectorAll("#tablaAscensoVallSala tbody tr");
...
const proximidadFija = 70; // Ajusta este valor según tus necesidades
const equipos = [];
let index = 1;
...
const tabla = document.querySelector("#tablaAscensoVallSala tbody");
tabla.innerHTML = ""; // Limpiar la tabla antes de actualizar
equipos.forEach((equipoData) => {
    const nuevaFila = document.createElement("tr");
    let claseColor = '';
    if (equipoData.index <= 3) {
    ...
    equipoData.equipo.includes("FS Valladolid") ? "equipo-pucela" : ""}">${equipoData.equipo}</td>
...
/*const filas1 = document.querySelectorAll("#tablaPlayGalvan tbody tr");
...
const filas2 = document.querySelectorAll("#tablaDescVallSala tbody tr");
...
const proximidadFijar2 = 42; // Ajusta este valor según tus necesidades
const equipos2 = [];
let index2 = 1;
...
const tabla2 = document.querySelector("#tablaDescVallSala tbody");
...
equipos2.forEach((equipo2Data) => {
    ...
    <td class="equipo-mobile text-start size_equipos2 ${
    equipo2Data.equipo2.includes("FS Valladolid") ? "equipo-pucela" : ""}">${equipo2Data.equipo2}</td>
