...
equipos.forEach((equipoData) => {
    ...
    equipoData.equipo.includes("CD Parquesol") ? "equipo-pucela" : ""}">${equipoData.equipo}</td>
...
equipos2.forEach((equipo2Data) => {
    ...
    <td class="equipo-mobile text-start size_equipos2 ${
    equipo2Data.equipo2.includes("CD Parquesol") ? "equipo-pucela" : ""}">${equipo2Data.equipo2}</td>
