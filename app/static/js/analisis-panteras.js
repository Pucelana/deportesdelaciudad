...
/*const filas = document.querySelectorAll("#tablaAscensoPanteras tbody tr");
...
const tabla = document.querySelector("#tablaAscensoPanteras tbody");
...
const filas1 = document.querySelectorAll("#tablaPlayPanteras tbody tr");
...
const proximidadFija1 = 54; // Ajusta este valor según tus necesidades
const equipos1 = [];
let index1 = 1;
filas1.forEach((fila) => {
...
const tabla1 = document.querySelector("#tablaPlayPanteras tbody");
...
equipos1.forEach((equipo1Data) => {
    ...
    equipo1Data.equipo1.includes("Panteras Caja Rural") ? "equipo-pucela" : ""}">${equipo1Data.equipo1}</td>
...
const filas2 = document.querySelectorAll("#tablaDescPanteras tbody tr");
...
const proximidadFijar2 = 15; // Ajusta este valor según tus necesidades
const equipos2 = [];
let index2 = 1;
filas2.forEach((fila) => {
...
const tabla2 = document.querySelector("#tablaDescPanteras tbody");
...
equipos2.forEach((equipo2Data) => {
    ...
    <td class="equipo-mobile text-start size_equipos2 ${
    equipo2Data.equipo2.includes("Panteras Caja Rural") ? "equipo-pucela" : ""}">${equipo2Data.equipo2}</td>
    ...
    <td class="desc-opti equipo-mobile text-center">${equipo2Data.partidosGanadosOptimistas2}</td>
    <td class="desc-pesi equipo-mobile text-center">${equipo2Data.partidosGanadosPesimistas2}</td>
    `;
