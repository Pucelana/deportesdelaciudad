...
const filas1 = document.querySelectorAll("#tablaPlayCDSIVall tbody tr");
...
const tabla1 = document.querySelector("#tablaPlayCDSIVall tbody");
...
equiposPlay.forEach((equipoData) => {
    ...
    nuevaFila.innerHTML = `
    <td class="fw-bold text-center equipo-mobile ${claseColor1}">${equipoData.index1}</td>
    <td class="fw-bold size_equipos2 equipo-mobile text-start">${equipoData.equipo}</td>
...
const filas2 = document.querySelectorAll("#tablaDescCDSIVall tbody tr");
...
// Actualizar la tabla con los datos ordenados
const tabla2 = document.querySelector("#tablaDescCDSIVall tbody");
...
equiposDesc.forEach((equipoData) => {
    ...
    nuevaFila.innerHTML = `
    <td class="fw-bold equipo-mobile text-center ${claseColor2}">${equipoData.index2}</td>
    <td class="fw-bold text-start size_equipos2 equipo-mobile">${equipoData.equipo}</td>
